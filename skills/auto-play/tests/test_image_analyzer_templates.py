...
def test_stat_delta_text_is_not_clickable_ocr_text(tmp_path):
    ...
    assert analyzer._looks_like_noise_text('xx')
    assert analyzer._looks_like_noise_text('XX')
    assert analyzer._looks_like_noise_text('BEA')
    assert analyzer._looks_like_noise_text('-28M')
    assert analyzer._looks_like_noise_text('6.72M-6.726.7')
    assert analyzer._looks_like_noise_text('L-37B')
    ...
    assert analyzer._looks_like_noise_text('123)')
    assert analyzer._looks_like_noise_text('36/50]')
    assert analyzer._looks_like_noise_text('[6')
    assert analyzer._looks_like_noise_text('4.778,77B7')
    assert analyzer._looks_like_noise_text('06:2!')
    assert analyzer._looks_like_noise_text('(5.06B')
    assert analyzer._looks_like_noise_text('xK6224')
    ...
    assert not analyzer._looks_like_noise_text('Drone')
    assert not analyzer._looks_like_noise_text('1-tap buy')
